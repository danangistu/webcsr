...
@section('title')Edit Sarana dan Prasarana @endsection
@push('style')
...
<div id="content-container">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow">Edit Data Sarana dan Prasarana</h1>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
            ...
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <div id="demo-bv-wz">
                        ...
                        <!--Form-->
                        {{ Form::model($model, array('route' => array('sarana.update', $model->id),'files'=> true,'id'=>'demo-bv-wz-form','class'=>'form-horizontal', 'method' => 'PUT')) }}
                            ...
                            <div class="panel-body">
                                <div class="tab-content">
                                    ...
                                    <div id="demo-bv-tab3" class="tab-pane">
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">Absensi </label>
                                            <div class="col-lg-3">
                                                <input accept=".doc, .docx,.pdf" type="file" class="form-control" name="doc_absensi">
                                            </div>
                                            <div class="col-lg-4">
    											<input type="text" class="form-control" value="{{ $model->doc_absensi }}" disabled />
                                            </div>
                                        </div>
                                    </div>
