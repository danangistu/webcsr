...
@section('title')Edit Pemasaran Produk @endsection
@push('style')
...
<div id="content-container">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow">Edit Data Pemasaran Produk</h1>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
            ...
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <div id="demo-bv-wz">
                        ...
                        <!--Form-->
                        {{ Form::model($model, array('route' => array('pemasaran.update', $model->id),'files'=> true,'id'=>'demo-bv-wz-form','class'=>'form-horizontal', 'method' => 'PUT')) }}
                            ...
                            <div class="panel-body">
                                <div class="tab-content">
                                    ...
                                    <div id="demo-bv-tab6" class="tab-pane mar-btm text-center">
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">Informasi Pemasaran</label>
                                            <div class="col-lg-7">
                                                <textarea class="form-control" name="info_pemasaran" rows="6">{{ isset($evaluasi->info_pemasaran) ? $evaluasi->info_pemasaran:null }}</textarea>
                                            </div>
                                        </div>
