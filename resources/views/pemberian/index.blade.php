...
@section('title')Bantuan Pelayanan Bencana Alam @endsection
@push('style')
...
<div id="content-container">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Pemberian Bantuan Bencana Alam</li>
    </ol>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End breadcrumb-->
    ...
    <div id="page-content">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Tabel Pemberian Bantuan Bencana Alam </h3>
            </div>
            <div class="panel-body">
                <a href="{{ url('bencana/pemberian/create/'.$bencana_id) }}" class="btn btn-primary"><span class="fa fa-plus"></span> Tambah Data</a>
            </div>
            <div class="panel-body">
...
$('.btn.btn-danger.btn-icon.icon-lg.fa.fa-trash').on('click', function(){
    ...
    bootbox.confirm("Apakah anda yakin akan menghapus data?", function(result) {
        if (result) {
            window.location.replace(locale + '/bencana/pemberian/delete/'+id);
        }else{
            $.niftyNoty({
                type: 'info',
                icon : 'fa fa-minus',
