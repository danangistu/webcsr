...
@section('title')Create Pelayanan Bantuan Pengembangan dan Modal Usaha @endsection
@push('style')
...
<div id="content-container">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow">Tambah Data Pelayanan Bantuan Pengembangan dan Modal Usaha</h1>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
            ...
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <div id="demo-bv-wz">
                        ...
                        <!--Form-->
                        <form id="demo-bv-wz-form" action="{{ url('modal') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
