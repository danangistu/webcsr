...
@section('title')Pelayanan Bantuan Bencana Alam @endsection
@push('style')
...
<div id="content-container">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow">Bantuan Pelayanan Bencana Alam</h1>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Pelayanan Bantuan Bencana Alam</li>
    </ol>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End breadcrumb-->
    ...
    <div id="page-content">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Tabel Pelayanan Bantuan Bencana Alam</h3>
            </div>
            <div class="panel-body">
                <a href="{{ url('bencana/create') }}" class="btn btn-primary"><span class="fa fa-plus"></span> Tambah Data</a>
            </div>
            <div class="panel-body">
                ...
                <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th>Anggaran</th>
                            <th width="10%"></th>
                            <th width="10%">Bantuan yang Diberikan</th>
                        ...
                        <?php $count_pemberian = $pemberian->where('bencana_id','=',$model->id)->count(); ?>
                            <tr class="{{ $model->kode == '' ? 'danger':null }}">
                                ...
                                <td>
                                  ...
                                  <a href="{{ url('bencana/laporan/'.$model->id) }}" type="button" class="btn btn-primary btn-block">Ajukan Laporan</a>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('bencana/'.$model->id.'/edit') }}" class="btn btn-warning btn-icon icon-lg fa fa-pencil-square"></a>
...
$('.btn.btn-danger.btn-icon.icon-lg.fa.fa-trash').on('click', function(){
    ...
    bootbox.confirm("Apakah anda yakin akan menghapus data?", function(result) {
        if (result) {
            window.location.replace(locale + '/bencana/delete/'+id);
        }else{
            $.niftyNoty({
                type: 'info',
                icon : 'fa fa-minus',
...
$('.btn.btn-success.btn-anggaran').on('click', function(){
    var id = $(this).attr('id');
    $.ajax({
        url: locale + '/bencana/get-anggaran/'+id,
