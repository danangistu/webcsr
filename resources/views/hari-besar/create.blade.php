...
@section('title')Create Partisipasi Hari Besar @endsection
@push('style')
...
<div id="content-container">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow">Tambah Data Partisipasi Hari Besar</h1>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
            ...
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <div id="demo-bv-wz">
                        ...
                        <!--Form-->
                        <form id="demo-bv-wz-form" action="{{ url('hari-besar') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
