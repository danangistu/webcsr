        ...
        <div class="tab-base tab-stacked-left">
        	...
        	<div class="tab-content">
        		...
        		<div id="demo-stk-lft-tab-3" class="tab-pane fade">
                    ...
                    <a href="{{ url('contents/pendidikan/document/'.$model->doc_kerjasama) }}" class="btn btn-primary btn-labeled fa fa-arrow-down">{{ $model->doc_kerjasama }}</a>
                    <p>Rencana Anggaran Biaya :</p>
                    <a href="{{ url('contents/pendidikan/document/'.$model->doc_anggaran) }}" class="btn btn-primary btn-labeled fa fa-arrow-down">{{ $model->doc_anggaran }}</a>
                    <p>Dokumen Manajemen Resiko  :</p>
                    <a href="{{ url('contents/pendidikan/document/'.$model->doc_resiko) }}" class="btn btn-primary btn-labeled fa fa-arrow-down">{{ $model->doc_resiko }}</a>
                    <p>TOR Term Of Reference   :</p>
                    <a href="{{ url('contents/pendidikan/document/'.$model->doc_tor) }}" class="btn btn-primary btn-labeled fa fa-arrow-down">{{ $model->doc_tor }}</a>
                    <p>Laporan Akhir    :</p>
                    <a href="{{ url('contents/pendidikan/document/'.$model->doc_laporan) }}" class="btn btn-primary btn-labeled fa fa-arrow-down">{{ $model->doc_laporan }}</a>
                    <p>Laporan Evaluasi :</p>
                    <a href="{{ url('contents/pendidikan/document/'.$model->doc_evaluasi) }}" class="btn btn-primary btn-labeled fa fa-arrow-down">{{ $model->doc_evaluasi }}</a>
        		</div>
