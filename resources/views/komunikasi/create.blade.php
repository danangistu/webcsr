...
@section('title')Create Komunikasi Sosial @endsection
@push('style')
            ...
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <div id="demo-bv-wz">
                        ...
                        <!--Form-->
                        <form id="demo-bv-wz-form" action="{{ url('komunikasi') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
