...
@section('title')Edit Komunikasi Sosial @endsection
@push('style')
            ...
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <div id="demo-bv-wz">
                        ...
                        <!--Form-->
                        {{ Form::model($model, array('route' => array('komunikasi.update', $model->id),'files'=> true,'id'=>'demo-bv-wz-form','class'=>'form-horizontal', 'method' => 'PUT')) }}
