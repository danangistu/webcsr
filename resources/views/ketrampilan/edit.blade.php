...
@section('title')Edit Pelayanan Ketrampilan @endsection
@push('style')
...
<div id="content-container">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow">Edit Data Pelayanan Ketrampilan</h1>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
            ...
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <div id="demo-bv-wz">
                        ...
                        <!--Form-->
                        {{ Form::model($model, array('route' => array('ketrampilan.update', $model->id),'files'=> true,'id'=>'demo-bv-wz-form','class'=>'form-horizontal', 'method' => 'PUT')) }}
                            ...
                            <div class="panel-body">
                                <div class="tab-content">
                                    ...
                                    <div id="demo-bv-tab6" class="tab-pane mar-btm text-center">
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">Ringkasan Materi</label>
                                            <div class="col-lg-7">
                                                <textarea class="form-control" name="ringkasan_materi" rows="6">{{ isset($evaluasi->ringkasan_materi) ? $evaluasi->ringkasan_materi:null }}</textarea>
                                            </div>
                                        </div>
                                        <p class="text-muted">Klik finish untuk menyimpan data.</p>
                                    </div>
