...
Route::get('kesehatan/laporan/{id}', 'KesehatanController@getLaporan');
Route::post('kesehatan/laporan/{id}', 'KesehatanController@postLaporan');
...
Route::get('pendidikan/laporan/{id}', 'PendidikanController@getLaporan');
Route::post('pendidikan/laporan/{id}', 'PendidikanController@postLaporan');
...
Route::get('bencana/laporan/{id}', 'BencanaController@getLaporan');
Route::post('bencana/laporan/{id}', 'BencanaController@postLaporan');
//Komunikasi Sosial
...
Route::get('komunikasi/laporan/{id}', 'KomunikasiController@getLaporan');
Route::post('komunikasi/laporan/{id}', 'KomunikasiController@postLaporan');
...
Route::get('hari-besar/laporan/{id}', 'HariBesarController@getLaporan');
Route::post('hari-besar/laporan/{id}', 'HariBesarController@postLaporan');
...
Route::get('kegiatan-masyarakat/laporan/{id}', 'KegiatanController@getLaporan');
Route::post('kegiatan-masyarakat/laporan/{id}', 'KegiatanController@postLaporan');
...
Route::get('modal/laporan/{id}', 'ModalController@getLaporan');
Route::post('modal/laporan/{id}', 'ModalController@postLaporan');
...
Route::get('ketrampilan/laporan/{id}', 'KetrampilanController@getLaporan');
Route::post('ketrampilan/laporan/{id}', 'KetrampilanController@postLaporan');
//Pelayanan Pemasaran
...
Route::get('pemasaran/laporan/{id}', 'PemasaranController@getLaporan');
Route::post('pemasaran/laporan/{id}', 'PemasaranController@postLaporan');
//Pelayanan Bantuan Modal
